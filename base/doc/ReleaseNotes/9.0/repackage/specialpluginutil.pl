...
# deals with very special cases in the org.cougaar.core.plugin.util package
...
#	print "\nfile name is: ", $file;
	if (substr($file, -19) eq "ExpanderHelper.java") {
	    $found++;
	    process_blackboard($_);
	} 
    }
}
