...
java.exe -Dorg.cougaar.core.persistence.enable=true -Xbootclasspath:%COUGAAR_INSTALL_PATH%\lib\javaiopatch.jar;%JDK_INSTALL_PATH%\jre\lib\rt.jar;%JDK_INSTALL_PATH%\jre\lib\jsse.jar %MYPROPERTIES% %MYMEMORY% -classpath %LIBPATHS% %MYCLASSES% %MYARGUMENTS% %2 %3
