 ...
 INSERT INTO V4_ALIB_COMPONENT \
  ...
  SELECT DISTINCT \
   ...
   WHERE \
     ...
     AND OT.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
     AND PG.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
  ...
  SELECT DISTINCT \
   ...
   FROM \
    ...
    WHERE \
       AA.ASSEMBLY_ID= ':assembly_id' \
      AND AA.COMPONENT_LIB_ID=OT.ORG_ID \
      AND OPG.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
      AND OT.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
      AND PL.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
 ...
 INSERT INTO  V4_ASB_AGENT_PG_ATTR \
  ...
  SELECT DISTINCT \
   ...
   WHERE \
     ...
     AND PGA.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id' ) \
...
addPluginAgentASBComponentArg = \
 INSERT INTO  V4_ASB_COMPONENT_ARG  \
  ...
  WHERE \
    ...
    AND CPA.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
...
addASBOplans = \
 INSERT INTO  V4_ASB_OPLAN \
   ...
   FROM \
    V6_CFW_OPLAN OP \
   WHERE \
    OP.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
...
addASBOplanAgentAttr = \
 INSERT INTO  V4_ASB_OPLAN_AGENT_ATTR  \
  ...
  WHERE \
   AA.ASSEMBLY_ID=':assembly_id' \
   AND OOA.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
   AND OGOM.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
...
getOrganizationGroups = \
 ...
 where \
  ...
  AND EXP.CFW_GROUP_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
  AND OGOM.CFW_ID IN (SELECT CFW_ID FROM V6_CFW_GROUP_MEMBER WHERE CFW_GROUP_ID=':cfw_group_id') \
